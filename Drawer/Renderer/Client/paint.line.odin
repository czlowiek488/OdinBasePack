...
drawLine :: proc(
	...
	if start.y < end.y {
		updateRenderZIndexPosition(module, line.paintId, line.config.layer, start) or_return
	} else if start.y > end.y {
		updateRenderZIndexPosition(module, line.paintId, line.config.layer, end) or_return
